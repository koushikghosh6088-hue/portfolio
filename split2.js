...
// Find boundaries
const sAbout = content.indexOf('<!-- ═══════════════════════════════════════\r\n       ABOUT SECTION');
const sServices = content.indexOf('<!-- ═══════════════════════════════════════\r\n       SERVICES SECTION');
const sShowcase = content.indexOf('<!-- ═══════════════════════════════════════\r\n       SHOWCASE / PORTFOLIO SECTION');
const sProcess = content.indexOf('<!-- ═══════════════════════════════════════\r\n       HOW WE WORK (PROCESS) SECTION');
const sPricing = content.indexOf('<!-- ═══════════════════════════════════════\r\n       PRICING SECTION');
const sContact = content.indexOf('<!-- ═══════════════════════════════════════\r\n       CONTACT & CTA SECTION');
const sFooter = content.indexOf('<!-- ═══════════════════════════════════════\r\n       FOOTER');
...
// Remove Hero from subpages
const sHome = newHeader.indexOf('<!-- ═══════════════════════════════════════\r\n       HERO SECTION');
const eHome = newHeader.indexOf('</section>', sHome) + 10;
const subHeader = newHeader.substring(0, sHome) + newHeader.substring(eHome);
