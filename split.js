...
fs.writeFileSync('about.html', newHeader + about_section + newFooter);
fs.writeFileSync('services.html', newHeader + services_section + showcase_section + process_section + pricing_section + newFooter);
fs.writeFileSync('contact.html', newHeader + contact_section + newFooter);
