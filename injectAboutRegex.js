...
const regex = /(<footer[^>]*id="contact"[^>]*>)/i;
const match = html.match(regex);

if (match) {
  html = html.replace(regex, aboutSection + match[1]);
  fs.writeFileSync(indexFile, html, 'utf8');
  console.log('Successfully injected About Us section with regex');
} else {
  console.log('Failed to find footer contact section with regex');
}
