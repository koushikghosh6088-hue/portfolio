    ...
    <div class="container">
      ...
      <div class="s-grid">
        ...
        <div class="s-card" id="s-card-2">
          ...
          <!-- Mockup -->
          <div class="s-mockup-container tech-trigger-chat" style="height: auto !important; padding: 40px 0; align-items: flex-start;">

            <div style="height: auto !important; padding: 40px 0; align-items: flex-start; width: 100%; display: flex; justify-content: center;">
        ...
        <div class="s-card" id="s-card-3">
          ...
          <!-- Mockup -->
          <div class="s-mockup-container tech-trigger-wa" style="height: auto !important; padding: 40px 0; align-items: flex-start;">
