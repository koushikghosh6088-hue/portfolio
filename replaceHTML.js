        ...
        <div class="s-card" id="s-card-1">
          ...
          <div class="s-mockup-container">
            <div class="mock-browser advanced redesigned">
              ...
              <div class="mb-body">
                <div class="mb-build-area">
                  <div class="mb-wire-nav"></div>
                  <div class="mb-wire-hero">
                     <div class="mb-wh-img"></div>
                     <div class="mb-wh-text">
                        <div class="wh-t1"></div><div class="wh-t2"></div>
                     </div>
                  </div>
                  <div class="mb-wire-btn"></div>
                  <div class="mb-wire-grid">
                     <div class="mb-wg-card"></div><div class="mb-wg-card"></div><div class="mb-wg-card"></div>
                  </div>
                </div>
                <div class="mb-cursor">
          ...
          <div class="s-mockup-container">
            <div class="mock-dash advanced">
              ...
              <div class="md-chart-area">
                ...
                <div class="md-bars">
                  <div class="md-bar mb-b1"><div class="md-bar-inner"></div></div>
                  <div class="md-bar mb-b2"><div class="md-bar-inner"></div></div>
                  <div class="md-bar mb-b3"><div class="md-bar-inner"></div></div>
                  <div class="md-bar mb-b4"><div class="md-bar-inner"></div></div>
                  <div class="md-bar mb-b5"><div class="md-bar-inner"></div></div>
                  <div class="md-bar mb-b6"><div class="md-bar-inner"></div></div>
                </div>
              </div>
            </div>
