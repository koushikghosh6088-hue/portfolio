      ...
      <div class="s-grid">
        ...
        <div class="s-card" id="s-card-2">
          ...
          <div class="s-mockup-container tech-trigger-chat">
            ...
            <div style="zoom: 0.75; width: 100%; display: flex; justify-content: center;">
          ...
          <div class="s-mockup-container">
            <div class="mock-iphone">
              ...
              <div class="mi-screen">
                ...
                <div class="mi-scroll" style="padding: 0;">
        ...
        <div class="s-card" id="s-card-5">
          ...
          <!-- Mockup -->
          <div class="s-mockup-container">
            <div class="mock-dash advanced" style="overflow: hidden; padding: 0; position: relative;">
        ...
        <div class="s-card" id="s-card-6">
          ...
          <!-- Mockup -->
          <div class="s-mockup-container">
            <div class="mock-pipe advanced" style="overflow: hidden; padding: 0; position: relative; display: flex; justify-content: center; align-items: center;">
